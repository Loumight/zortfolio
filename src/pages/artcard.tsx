...
export default function Card({ image, title, desc }: CardInfo ) {
  return (
      <div className="flex flex-col overflow-hidden rounded-xl shadow-xl/20 hover:scale-101 transition-transform duration-100 pointer-events-auto">
       <div className="h-100 shrink-0 bg-cover bg-center animate-reveal cursor-target"
